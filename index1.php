...
<div id="board_area"> 
  <h1>맛집게시판</h1>
  <h4>맛집 관련 글을 쓸 수 있는 게시판입니다.</h4>
  <div id="search_box">
    <form action="/BBS/search_result.php" method="get">
      <select name="catgo">
    ...
    <table class="list-table">
      ...
      <tbody>
        ...
        if($board['lock_post']=="1")
         ...
         <a href='/BBS/read.php?idx=<?php echo $board["idx"]; ?>'><?php echo $title; }?><span class="re_ct" style="font-weight:bold; color:blue;">[<?php echo $rep_count; ?>]</span></a></td>
