...
<div id="board_read">
	<h2><?php echo $board['title']; ?></h2>
		<div id="user_info">
			...
			<?php
			if($bno==1){ 
				echo "<img src='mom.jpeg' width='300'>";
			}
			if($bno==2){ 
				echo "<img src='jjbb.jpeg' width='300'>";
			}
			if($bno==3){ 
				echo "<img src='dduck.jpeg' width='300'>";
			}
			if($bno==4){ 
				echo "<img src='sbsb.jpeg' width='300'>";
			}
			if($bno==5){ 
				echo "<img src='jb.jpg' width='300'>";
			}
			if($bno==6){ 
				echo "<img src='sgg.jpeg' width='300'>";
			}
			if($bno==7){ 
				echo "<img src='yggch.jpeg' width='300'>";
			}
			?>
	<!-- 목록, 수정, 삭제 -->
	<div id="bo_ser">
		<ul>
			<li><a href="/BBS/index1.php">[목록으로]</a></li>
